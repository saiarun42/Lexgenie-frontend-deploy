...
const Layout: React.FC = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            const res = await fetch('http://44.211.157.24:8000/review-contract', {
                method: 'POST',
                body: formData,
            });
            ...
            setContractSummary(data.reviewed_contract); // Update state with reviewed contract

            // Send reviewed contract to chat
            setChatMessages((prevMessages) => [
                ...prevMessages,
                { text: data.reviewed_contract, fromUser: false },
            ]);
    ...
    return (
        <div className="flex min-h-screen bg-gray-100">
            ...
            <div className="w-1/5 p-4 bg-white border-r border-gray-300">
                <Returnpage />
                <h2 className="text-xl font-bold mb-4">Review Contract</h2>
                <div className="mb-6">

                    <p> Instantly analyze contract terms, obligations, key clauses, payment terms, and potential pitfalls with ease.</p>
                ...
                <button
                    ...
                    className="w-full black bg-black text-white p-2 rounded hover:bg-gray-600"
                >
                    Upload
                </button>
            </div>
            ...
            <div className="w-4/5 p-4 flex flex-col ">
                <div className="flex-grow bg-white p-4 mb-4 border rounded-md">
                    <h2 className="text-xl font-bold mb-2">Review Contract</h2>
                    {documents.length > 0 && (
                        <button
